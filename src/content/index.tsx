...
import { addPeak, updateVideoState } from "./timelineState";
...
function mountTimeline() {
  ...
  const primaryInner = document.querySelector('#primary-inner') || document.querySelector('#below')?.parentElement;
...
function monitorAudio() {
  mountTimeline(); // constantly attempt to mount if not mounted yet
  
  if (!mediaElement || !config.enabled) return;
