    ...
    <div class="flex flex-shrink-0 w-full flex-col my-4 border border-gray-300 bg-white shadow-sm rounded-lg overflow-hidden">
      ...
      <div class="flex flex-shrink-0 flex-wrap items-center px-4 py-2 bg-slate-50 border-b border-gray-200 text-sm gap-4 sm:gap-8">
        ...
        <div class="flex items-center gap-3">
          <label class="font-medium text-slate-600 whitespace-nowrap">Threshold <span class="text-cyan-600 w-12 inline-block text-right">{threshold()} dB</span></label>
          <input 
            type="range" 
        ...
        <div class="flex items-center gap-3">
          <label class="font-medium text-slate-600 whitespace-nowrap">Padding <span class="text-purple-600 w-8 inline-block text-right">{padding()} s</span></label>
          <input 
            type="range" 
