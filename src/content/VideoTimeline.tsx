...
export const VideoTimeline: Component = () => {
  ...
  return (
    <div class="flex flex-shrink-0 w-full flex-col my-4 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
      {/* Controls Header */}
      <div class="flex flex-shrink-0 flex-wrap items-center px-4 py-2 bg-slate-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 text-sm gap-4 sm:gap-8">
        <a
          href="https://silenceslicer.com"
          target="_blank"
          rel="noopener noreferrer"
          class="flex items-center gap-2 font-bold text-slate-800 dark:text-slate-200 hover:text-blue-600 transition-colors"
        >
        ...
        <div class="flex items-center gap-4 ml-auto">
          ...
          <button
            ...
            class="flex items-center justify-center w-8 h-8 rounded-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 transition-colors"
      ...
      <div class="flex w-full flex-col">
        <div class="flex w-full flex-row" style="height: 60px;">
          ...
          <div class="flex w-8 flex-none flex-col items-center border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 pt-[1px]">
            <div
        ...
        {/* SCROLLBAR */}
        <div class="flex px-2 py-1 items-center gap-2 bg-slate-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
